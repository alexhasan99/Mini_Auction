...
namespace Mini_Auction.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly IUserEmailStore<AuctionUser> _emailStore;
        ...
        private IUserEmailStore<AuctionUser> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<AuctionUser>)_userStore;
        }
    }
}
